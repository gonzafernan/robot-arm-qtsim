...
* Bibliografía
- Modelo 3D del robot: [[https://grabcad.com/library/mitsubishi-rv-6s-1][Mitsubishi RV-6S Industrial MELFA
Series]]
...
información para poder realizar el proyecto en el framework Qt, se
